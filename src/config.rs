...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.91.118.109"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 26866;
pub const RELAY_PORT: i32 = 26867;
pub const WS_RENDEZVOUS_PORT: i32 =26868;
pub const WS_RELAY_PORT: i32 = 26869;
