...
pub const RENDEZVOUS_SERVERS: &[&str] = &["45.125.218.3"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 20266;
pub const RELAY_PORT: i32 = 20267;
pub const WS_RENDEZVOUS_PORT: i32 =20268;
pub const WS_RELAY_PORT: i32 = 20269;
