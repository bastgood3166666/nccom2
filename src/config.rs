...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("广义宝.".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["45.125.218.15"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 24166;
pub const RELAY_PORT: i32 = 24167;
pub const WS_RENDEZVOUS_PORT: i32 =24168;
pub const WS_RELAY_PORT: i32 = 24169;
