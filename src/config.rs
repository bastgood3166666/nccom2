...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.229.109.11"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 25766;
pub const RELAY_PORT: i32 = 25767;
pub const WS_RENDEZVOUS_PORT: i32 =25768;
pub const WS_RELAY_PORT: i32 = 25769;
