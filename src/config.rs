...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("办易通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.91.116.170"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 27966;
pub const RELAY_PORT: i32 = 27967;
pub const WS_RENDEZVOUS_PORT: i32 =27968;
pub const WS_RELAY_PORT: i32 = 27969;
