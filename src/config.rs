...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("广议宝.".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["45.125.218.20"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 24066;
pub const RELAY_PORT: i32 = 24067;
pub const WS_RENDEZVOUS_PORT: i32 =24068;
pub const WS_RELAY_PORT: i32 = 24069;
