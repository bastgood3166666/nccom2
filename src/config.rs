...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.229.91.118"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 23566;
pub const RELAY_PORT: i32 = 23567;
pub const WS_RENDEZVOUS_PORT: i32 =23568;
pub const WS_RELAY_PORT: i32 = 23569;
