...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("常议通.".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.229.91.12"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 25066;
pub const RELAY_PORT: i32 = 25067;
pub const WS_RENDEZVOUS_PORT: i32 =25068;
pub const WS_RELAY_PORT: i32 = 25069;
