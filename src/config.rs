...
pub const RENDEZVOUS_SERVERS: &[&str] = &["103.101.178.146"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 26466;
pub const RELAY_PORT: i32 = 26467;
pub const WS_RENDEZVOUS_PORT: i32 =26468;
pub const WS_RELAY_PORT: i32 = 26469;
