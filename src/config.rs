...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.193.247.194"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 27266;
pub const RELAY_PORT: i32 = 27267;
pub const WS_RENDEZVOUS_PORT: i32 =27268;
pub const WS_RELAY_PORT: i32 = 27269;
