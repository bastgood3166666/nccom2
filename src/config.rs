...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("亿办宝".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["103.101.178.150"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 27566;
pub const RELAY_PORT: i32 = 27567;
pub const WS_RENDEZVOUS_PORT: i32 =27568;
pub const WS_RELAY_PORT: i32 = 27569;
