...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.252.60.102"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 27666;
pub const RELAY_PORT: i32 = 27667;
pub const WS_RENDEZVOUS_PORT: i32 =27668;
pub const WS_RELAY_PORT: i32 = 27669;
