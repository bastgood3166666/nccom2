...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.252.60.100"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 27166;
pub const RELAY_PORT: i32 = 27167;
pub const WS_RENDEZVOUS_PORT: i32 =27168;
pub const WS_RELAY_PORT: i32 = 27169;
