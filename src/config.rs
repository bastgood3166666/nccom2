...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.252.60.98"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 26566;
pub const RELAY_PORT: i32 = 26567;
pub const WS_RENDEZVOUS_PORT: i32 =26568;
pub const WS_RELAY_PORT: i32 = 26569;
